...
4. "keywords": Un arreglo de strings con 1 a 3 palabras clave optimizadas específicamente para realizar búsquedas en el **mercado nacional chileno** (ej. Mercado Libre).
   REGLA DE ORO PARA KEYWORDS: 
   - Si el texto menciona un MODELO EXACTO, MARCA ESPECÍFICA, CARACTERÍSTICA TÉCNICA CLAVE (ej. "2TB", "7200 RPM", "SATA") o MEDIDA EXACTA, debes usar EXACTAMENTE ese término como primera keyword para que el cotizador encuentre el producto preciso.
   - Si requiere "instalación", añádelo como una keyword separada o menciónalo en el summary para que el usuario considere el costo adicional.
   - Omite palabras genéricas burocráticas (ej. "adquisición", "compra", "suministro").

Devuelve estrictamente un objeto JSON válido y nada más. Ejemplo de salida:
{
  "summary": "Se requieren 10 impresoras HP LaserJet M404dw con instalación en oficina.",
  "complexity": "alta",
  "profitability": "Media, el margen dependerá del costo de instalación.",
  "keywords": ["HP LaserJet M404dw", "Instalación impresora"]
}`;
            const contents = [
