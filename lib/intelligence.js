...
En el gobierno, los compradores suelen llenar el "Nombre" con categorías inútiles (ej. "Bandas de impresión", "Mejora de pastos"), pero ponen el producto real en la "Descripción" (ej. "PLA-CYAN 1 KILO", "Rollo de pasto sintético").

REGLAS CRÍTICAS:
1. IGNORA EL "NOMBRE" SI ES GENÉRICO. La "Descripción" MANDA.
2. Si la Descripción menciona el producto real (ej. "PLA-NEGRO", "Manguera jardín"), el término de búsqueda DEBE basarse 100% en la descripción.
3. El término final debe ser apto para Mercado Libre (ej. "Filamento PLA Negro", "Pasto Sintético", "Manguera Jardín").
...
- "razonamiento": Breve explicación de por qué elegiste el término (ej. "La descripción pide PLA Cyan, el nombre es genérico").
- "termino": El término de búsqueda optimizado para Mercado Libre (máximo 5 palabras).`;
